...
FontDetect = function()
{
    ...
    function _init ()
    {
        ...
        span.innerHTML = aChars[eLang] + '<i class="material-icons">play_arrow</i>';
        ...
        isFontLoaded: function (p_cssFontName)
        {
            ...
            for(var ix = 0; ix < _aFallbackFonts.length; ++ix)
            {
                ...
                if (ix > 0 && wThisFont != wPrevFont 
                    // Hack fo Firefox desktop
                    && wThisFont != 4555 && wThisFont != 4371 && wThisFont != 4184
                    // Hack fo Chrome desktop
                    && wThisFont != 3027 && wThisFont != 4391 && wThisFont != 4351)
